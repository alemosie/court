Card.create!(name: "Slayer1", description: "Wakes up with the slayers")
Card.create!(name: "Slayer2", description: "Wakes up with the slayers")
...
Ability.create!(name: "Slayer")
Ability.create!(name: "Assassin")
Ability.create!(name: "Spy")
Ability.create!(name: "Jester")
Ability.create!(name: "Caretaker")
Ability.create!(name: "Thief")
Ability.create!(name: "Meddler")
Ability.create!(name: "Royal Guard")
Ability.create!(name: "Royal Council")
Ability.create!(name: "Lord")
Ability.create!(name: "Lady")
Ability.create!(name: "King")
Ability.create!(name: "Commander")
Ability.create!(name: "Queen")
Ability.create!(name: "Cardinal")
Ability.create!(name: "Alchemist")
Ability.create!(name: "Fanatic")
